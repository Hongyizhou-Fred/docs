...
也可以在长桥 App 内，通过【左上角头像】→【设置】→【消息设置】管理通知偏好。

![](./images/P9E6beAZ7oJY7fxj9KCj0hhWpuh.png)
...
**提醒方向**： - **价格高于**：当股价涨到某个价格时提醒你（例如想在股价突破高位时知道） - **价格低于**：当股价跌到某个价格时提醒你（例如想在股价回调到心理价位时买入）
...
除了对个股进行提醒外，还可以用“全局提醒”对持仓或自选股票进行全局提醒。

## 第四步：确认提交

检查一遍： - 股票名称正确 - 提醒方向正确（高于 / 低于） - 目标价格正确
...
- 港股交易规则与结算 — 交易时间、T+2 交收等规则说明

- 订单类型说明 — 限价单、市价单等更多下单方式
