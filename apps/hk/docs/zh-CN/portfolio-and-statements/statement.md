...
长桥证券在交易后定期向客户发送日结单与月结单，可通过 App 或邮箱查看，支持简体中文、繁体中文、英文三种语言版本。[点击此处查看下载您的结单](lb://page/fortune/statement)

## 发送时间

日结单：产生交易的 2 个交易日内 月结单：下个月的 5 个交易日内
...
途径一：长桥 App > 资产 > 全部功能 > 结单查询，可按日期和类型选择对应结单查看。[点击此处查看下载您的结单](lb://page/fortune/statement)

![](./images/HGdDbjDXEo87y9xqQjnjl0TQpVd.png)

结单查询路径

途径二：前往开户时填写的邮箱下载查看。如需修改邮箱，可进入长桥 App > 左上角头像 > 设置 > 账号管理 > 邮箱 > 修改邮箱，修改成功后下个结单将发送至新邮箱。[点击此处查看下载您的结单](lb://page/fortune/statement)
...
修改路径：长桥 App > 左上角头像 > 设置 > 通用 > 语言设置 > App 语言，保存即可。
...
| 市值 | 证券总价值 + 基金总价值 + 现金总价值 + 余额通总价值 + 当月未结算净利息总价值 + 当月未结算累计分红总价值 |
...
期末资金余额 = 期初资金余额 + 变更金额 期末资金余额 = 已交收现金 + 待交收现金
...
期末持仓 = 期初持仓 + 变更数量 持仓市值 = 期末持仓 × 价格（股票和期权取收盘价，基金取净值）
