...
![](./images/Pu0Gbyrtkoysd3xnHqMjm0Acpye.png)
...
![](./images/A6twbJ4EaoJ8xFxTZ2Yj3c9Tpke.png)
...
美股当日盈亏受盘前盘后与夜盘开关影响，可在「设置」→「资产设置」中调整。 [点击此处进入设置首页](lb://page/mine/setting)

![](./images/QLEAbChT5oaUpkxLFXBjmxkopyd.png)
...
可在「资产首页」→「全部功能」→「资产设置」→「成本计算方式」切换。成本以股票实际交易币种计价。

### 持仓市值

当前市场下的持仓按市场对应币种折算后加总。如有非当前市场币种的持仓（例如港股市场下的人民币品种或美元品种），会折算为当前市场对应币种后再加总。
